...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [UpdateScoreTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#updatescoretemplate)
...
You can choose not to use any logic template and directly use the T# wrapper for resetting score - the  [ResetScoreTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#resetscoretemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [ChangeMagnetTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#changemagnettemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [ChangePlayerSpeedTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#changeplayerspeedtemplate)
