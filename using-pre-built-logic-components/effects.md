...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [PlayPlayerAnimationTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#playplayersanimationtemplate). You may also find the wrapper - [PlayerAnimationControlTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#playeranimationcontroltemplate) useful
