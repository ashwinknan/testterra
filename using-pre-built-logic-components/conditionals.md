...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [SwitchTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#switchtemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [TickTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#ticktemplate)
