...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper -  [DestroyTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#destroytemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [SetPositionTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#setpositiontemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [GrowTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#growtemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [MoveTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#movetemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [RotateTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#rotatetemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [MoveToPlayerTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#movetoplayertemplate)
...
If you want to further customize this logic template, you can do so by accessing its T# Wrapper - [RotateOscillateTemplate](../scripting-custom-logic-components/t-logic-template-wrappers.md#rotateoscillatetemplate)
